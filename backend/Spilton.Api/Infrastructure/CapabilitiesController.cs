...
public sealed class CapabilitiesController(IModelProviderResolver models,IMultimodalProvider multimodal,ICodeExecutionService execution,IUploadScanner scanner,IDistributedRateLimitStore rateLimits,IAccountEmailSender email):ControllerBase
{
    [HttpGet]
    public IActionResult Get()=>Ok(new
    {
        ...
        production=new{malwareScanning=scanner.Status,distributedRateLimiting=rateLimits.Status,passwordRecoveryEmail=email.Available?"CONFIGURED":"CONFIGURATION_REQUIRED"},
